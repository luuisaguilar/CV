...
- `enterprise-scene-prototype.tsx.txt` — unintegrated Three.js/React prototype preserved as a reference only.
...
- The prototype is stored as `.txt` and not imported by the app, so this PR should not change production behavior.
